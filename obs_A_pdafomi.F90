!$Id: obs_A_pdafomi.F90 910 2021-12-01 17:35:20Z lnerger $
...
! *** Local variables ***
    ...
    integer :: pos(2), cnt_(2)
    integer :: nsteps_file
    real(8), allocatable :: obs_reshaped(:,:)
...
! ***********************************************************
    ...
    DO j = 1, nx
       DO i= 1, ny
          IF (obs_reshaped(i,j) > -999.0)  then
            ! print *, obs_field(i,j)
            ! print *, cnt
            cnt = cnt + 1
          end if
