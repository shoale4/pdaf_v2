...
BASEDIR = ../..
# PDAF_ARCH = macos_gfortran_openmpi
...
# # NEW (SB 1/9/24) - COMMAND LINE ARGUMENTS FINALLY
# SPINUP_PHASE ?= 0
...
model : $(MODULES) $(OBJ_MODEL)
	$(LD) $(OPT_LNK)  -o $@  $(MODULES) $(OBJ_MODEL) $(NC_LIB) $(LINK_LIBS)
...
.F90.o :
	$(FC) $(OPT) $(CPP_DEFS) -I$(BASEDIR)/include $(NC_INC) -c $*.F90
